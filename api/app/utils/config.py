...
class Settings(BaseModel):
    ...
    session_idle_timeout_minutes: int = Field(default=5, alias="SESSION_IDLE_TIMEOUT_MINUTES")
    ...
    @field_validator("session_idle_timeout_minutes", mode="before")
    def _clamp_idle_timeout(cls, value: int | str) -> int:
        minutes = int(value)
